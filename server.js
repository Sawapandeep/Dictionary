...
// const getAllMeanings = (word) => {
//   return words.filter((w) => w.word.toLowerCase() === word.toLowerCase());
// };
...
//     if (!randomWord) break;
//     const allMeanings = getAllMeanings(randomWord.word);
//     randomWords.push(...allMeanings);
//   }
